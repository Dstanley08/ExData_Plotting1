...
#subset the Global Active Power (kilowatts) to be used in the plot
y_values=date_subset$V7
y_values2=date_subset$V8
y_values3=date_subset$V9
...
plot(x_values,y_values,type='l',col='black',xlab="",ylab="Energy sub metering")
lines(x_values,y_values2,type='l',col='red')
lines(x_values,y_values3,type='l',col='blue')
